...
class Welcome extends CI_Controller {
	...
	public function index(){
		...
		if($this->form_validation->run() == FALSE){
			...
			// $this->template->load('template', 'formLogin', $data);
			...
			if($cek == FALSE){
				$this->session->set_flashdata('pesan','<div class="alert alert-success alert-dismissible"><i class="icon fa fa-check"></i><strong>Username atau password salah.</strong>
