<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Filter Laporan SlipGaji Pegawai</li>
      </ol>
    </section>
    ...
    <section class="content">      
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Filter Laporan Slip Gaji</h3>
          </div>

          <div class="box-body table-responsive">
          <div class="panel panel-success" style="margin-top: 20px; text-align: center; width: 35%;margin-left: 30%">
					  <div class="panel-heading">
					    <h3 class="panel-title" style="color:black;">Filter Laporan Slip Gaji</h3>
					  </div>
					  ...
					  <div class="panel-body">
						...
						<button style="width: 100%" type="submit" class="btn btn-success"><i class="fas fa-print"> Cetak Slip Gaji</i></button>
